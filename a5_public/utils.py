...
def pad_sents_char(sents, char_pad_token):
    ...
    for sent in sents:
        # sent padding with zero_length_word as pad_token
        sent = sent + [zero_length_word] * (max_sent_length - len(sent))

        sent = [word[:21] + [char_pad_token] * (max_word_length - len(word)) for word in sent]
