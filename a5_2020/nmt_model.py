...
class NMT(nn.Module):
    ...
    def __init__(self, word_embed_size, hidden_size, vocab, dropout_rate=0.3, no_char_decoder=False):
        ...
        self.encoder = nn.LSTM(bidirectional=True, input_size=word_embed_size, hidden_size=hidden_size)
        self.decoder = nn.LSTMCell(input_size=word_embed_size+hidden_size, hidden_size=hidden_size)
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[
        ...
        enc_hiddens, source_lengths = pad_packed_sequence(enc_hiddens, batch_first=True)
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        # [b,h] squeeze [b,h,1]
        # [b,src_len,h] @ [b,h,1] bmm [b,src_len,1]
        # [b,src_len,1] unsqueeze [b,src_len]
        ...
        # [b,src_len] unsqueeze [b,1,src_len]
        # [b,1,src_len] @ [b,src_len,2h] bmm [b,1,2h]
        # [b,1,2h] squeeze [b,2h]
